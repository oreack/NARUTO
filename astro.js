...
async function syncdb() {
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "NARUTO-MD"],
      ...
      for (mek of callData.messages) {
        ...
        if (rawText && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          isCommand =
            ...
            (messageData.isAsta &&
              /2349117525115|923004591719|17863688449/g.test(botNumber) &&
              messageBody[0] == ",");
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2349117525115|2347043759577|17863688449/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "NARUTO-MD") +
        "\n";
      try {
  ...
  AstaConn.messageId = (length = 8, prefix = "NARUTO-MD") => {
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "2349117525115@s.whatsapp.net",
        },
      };
...
<head>
  ...
  <title>NARUTO Bouncing Text</title>
  <style>
    body, html {
      margin: 0;
      padding: 0;
...
app.listen(randomPort, () =>
  console.log(
    "NARUTO-MD Server listening on http://localhost:" + randomPort + "/ "
  )
);
