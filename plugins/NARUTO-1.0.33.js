  ...
  async (_0x5cb388, _0x302ad5) => {
    try {
      try {
        ...
        if (!_0x557719) {
          return man.reply("Provide me a query ex Who is NARUTO");
        }
...
smd(
  ...
  async (_0x42b3b8, _0x3f3887) => {
    try {
      ...
      if (!_0x1b0897) {
        return _0x42b3b8.reply("Provide me a query ex Who is NARUTO");
      }
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/therxcoder/NARUTO"
      );
      let _0x1c73f9 = (
        "\nNARUTO A simple Mutil Device WhatsApp Bot with rich library Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Creator:* RX-GΔMΞCØDΞR\n  *❲❒❳ Created:* " +
        (_0x44f98c?.created_at || "2024/06") +
        "\n  *❲❒❳ Repo:* _https://github.com/therxcoder/NARUTO_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
  ...
  async (_0x2acf30) => {
    try {
      if (
        ...
        if (
          _0x2acf30.reply_text.includes("NARUTO • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          _0x2dfb59[0].includes("NARUTO • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
