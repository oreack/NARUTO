...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/thenaruto-kpcoder/NARUTO-1.0_*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts Hi,I am NARUTO-1.0_ whatsapp bot._*");
    }
    try {
...
smd({
  ...
  try {
    ...
    let _0x4737bb = {
      audio: _0x2ba501,
      fileName: "NARUTO tiktok Sound" + _0x19c223 + ".m4a",
      mimetype: "audio/mpeg",
      ptt: true,
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x4b47c3 = "./assets/NARUTO" + _0x1d542b[1] + ".mp3";
    ...
    let _0x300d1a = {
      ...
      mimetype: "audio/mpeg",
      fileName: "NARUTO--" + _0x1d542b[1] + ".mp3",
      caption: Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("NARUTO • SONG DOWNLOADER")) {
    ...
    } else if (_0x5b8ee5[0].includes("NARUTO • SONG DOWNLOADER")) {
